...
public class UVCCameraHandler extends AbstractUVCCameraHandler {
     ...
     * @return
     */
    public static UVCCameraHandler createHandler(final Activity parent, final CameraViewInterface cameraView, final int width, final int height) {
    ...
    public String toString() {
        return "UVCCameraHandler{" + "name='" + name + '\'' + '}';
    }
}
