...
//================================================================================
    ...
    protected boolean checkPermissionWriteExternalStorage() {
        return checkPermissionWriteExternalStorage(this);
    }

    public static boolean checkPermissionWriteExternalStorage(AppCompatActivity context) {
        if (!PermissionCheck.hasWriteExternalStorage(context)) {
            MessageDialogFragmentV4.showDialog(context, REQUEST_PERMISSION_WRITE_EXTERNAL_STORAGE,
    ...
    protected boolean checkPermissionAudio() {
        return checkPermissionAudio(this);
    }

	public static boolean checkPermissionAudio(AppCompatActivity appCompatActivity) {
		if (!PermissionCheck.hasAudio(appCompatActivity)) {
			MessageDialogFragmentV4.showDialog(appCompatActivity, REQUEST_PERMISSION_AUDIO_RECORDING,
