...
public final class DeviceFilter {
    ...
    public DeviceFilter(final String manufacturer, final String product) {
...
/*		if (mManufacturerName != null && device.getManufacturerName() == null)
    ...
    public boolean equals(final Object obj) {
        ...
        if (obj instanceof UsbDevice) {
            ...
            if (isExclude || (device.getVendorId() != mVendorId) || (device.getProductId() != mProductId) || (device.getDeviceClass() != mClass) || (device.getDeviceSubclass() != mSubclass) || (device.getDeviceProtocol() != mProtocol)) {
                return false;
            }
/*			if ((mManufacturerName != null && device.getManufacturerName() == null)
